namespace DernekTakipApp.Forms
{
    partial class FormMemberDues
    {
        ...
        private void InitializeComponent()
        {
            ...
            LabelOcakOdenen = new Label();
            LabelSubatOdenen = new Label();
            LabelMartOdenen = new Label();
            LabelNisanOdenen = new Label();
            LabelMayisOdenen = new Label();
            LabelHaziranOdenen = new Label();
            LabelTemmuzOdenen = new Label();
            LabelAgustosOdenen = new Label();
            LabelEylulOdenen = new Label();
            LabelEkimOdenen = new Label();
            LabelKasimOdenen = new Label();
            LabelAralikOdenen = new Label();
            ...
            tableLayoutPanel2.Controls.Add(LabelOcakOdenen, 2, 1);
            tableLayoutPanel2.Controls.Add(LabelSubatOdenen, 2, 2);
            tableLayoutPanel2.Controls.Add(LabelMartOdenen, 2, 3);
            tableLayoutPanel2.Controls.Add(LabelNisanOdenen, 2, 4);
            tableLayoutPanel2.Controls.Add(LabelMayisOdenen, 2, 5);
            tableLayoutPanel2.Controls.Add(LabelHaziranOdenen, 2, 6);
            tableLayoutPanel2.Controls.Add(LabelTemmuzOdenen, 2, 7);
            tableLayoutPanel2.Controls.Add(LabelAgustosOdenen, 2, 8);
            tableLayoutPanel2.Controls.Add(LabelEylulOdenen, 2, 9);
            tableLayoutPanel2.Controls.Add(LabelEkimOdenen, 2, 10);
            tableLayoutPanel2.Controls.Add(LabelKasimOdenen, 2, 11);
            tableLayoutPanel2.Controls.Add(LabelAralikOdenen, 2, 12);
        ...
        public Label LabelOcakOdenen;
        public Label LabelSubatOdenen;
        public Label LabelMartOdenen;
        public Label LabelNisanOdenen;
        public Label LabelMayisOdenen;
        public Label LabelHaziranOdenen;
        public Label LabelTemmuzOdenen;
